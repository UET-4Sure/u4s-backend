...
export class Migrations1748701724725 implements MigrationInterface {
    name = 'Migrations1748701724725'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`pool_metrics\` (\`id\` varchar(36) NOT NULL, \`bucketStart\` timestamp NOT NULL, \`tvlUsd\` decimal(38,18) NOT NULL, \`volume24hUsd\` decimal(38,18) NOT NULL, \`fees24hUsd\` decimal(38,18) NOT NULL, \`aprForLps\` decimal(10,4) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`pool_id\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
